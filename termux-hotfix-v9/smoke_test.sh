...
TR="$(curl -fLsS --max-time 60 -H 'Content-Type: application/json'   -d '{"text":"Good morning.","source_language":"en","target_language":"nl","mode":"general"}'   "$BASE/v1/translate")" || fail "translation API request failed"
...
echo "[smoke] PASS — render/runtime APIs + STT + LLM + Supertonic"
