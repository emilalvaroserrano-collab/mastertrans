...
HOTFIX_BASE="https://raw.githubusercontent.com/emilalvaroserrano-collab/mastertrans/main/termux-hotfix-v3"

echo "[compat-v3] Applying Android/Python 3.14 compatibility hotfix — NO hf-xet / NO maturin"
